      ...
      <CRow>
        <CCol sm="6" lg="3">
          <TarjetaPeqGrafica
            ...
            datoTitulo={datosTotales}
            titulo="Obras totales Puebla"
            labelDatos="Datos"
          />
        </CCol>
        ...
        <CCol sm="6" lg="3">
          <TarjetaPeqGrafica
            ...
            datoTitulo={datosRojo}
            titulo="Obras en semáforo rojo"
            labelDatos="Datos"
          />
        </CCol>
        ...
        <CCol sm="6" lg="3">
          <TarjetaPeqGrafica
            ...
            datoTitulo={datosAmarillo}
            titulo="Obras en semáforo amarillo"
            labelDatos="Datos"
          />
        </CCol>
        ...
        <CCol sm="6" lg="3">
          <TarjetaPeqGrafica
            color="gradient-info"
            datoTitulo={datosAzul}
            titulo="Obras en semáforo azul"
            labelDatos="Datos"
          />
        </CCol>
      </CRow>
