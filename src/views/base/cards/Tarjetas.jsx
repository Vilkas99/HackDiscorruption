...
const TarjetaPeqObra = ({
  ...
  return (
    <CCard>
      <CCardHeader style={{ marginLeft: "10px", marginTop: "20px" }}>
        <h3>{titulo}</h3>
        <CRow>
          <text
            style={{
        ...
        <div className="card-header-actions">
          <CRow>
            <h4 style={{ marginRight: "30px" }}>Suscribirse</h4>
            <CSwitch
      ...
      <CCardBody>
        <CRow>
          <CCol>
            <CRow>
              <h5 style={{ margin: "20px", fontSize: "20px" }}>Nombre:</h5>
              <h5 style={{ margin: "20px", fontSize: "20px" }}>{nombre}</h5>
            </CRow>
            <h5 style={{ margin: "20px", fontSize: "20px" }}>
              Inversion: {cantInversion}
            </h5>
            <h5 style={{ margin: "20px", fontSize: "20px" }}>
              Beneficios44: {beneficios}
            </h5>
          </CCol>
        </CRow>
      </CCardBody>
